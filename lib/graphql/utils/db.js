...
export const getVersion = function (r, type, args) {
...
export const createRecord = function (r, type, payload) {
...
export const createVersionedRecord = function (r, type, payload) {
  ...
  return table.insert(payload, options).do(
    function (record) {
      if (useCurrent === true) {
        return ucTable.insert({
          type: type.table,
          id: record('_metadata')('recordId')
        }).do(function () {
          return record
        })
      }
    ...
    let newVal = _.get(result, 'changes[0].new_val')
    return newVal || result
  })
}

export const branchRecord = function (r, type, args) {
...
export const forkRecord = function (r, type, args) {
  return getVersion(r, type, args).then(function (record) {
    if (record) {
      return createRecord(r, type, _.merge(record, {
        _metadata: {
...
export const publishRecord = function (r, type, args) {
...
//  get the current major version
export const getCurrentMajorVersion = function (table, record) {
